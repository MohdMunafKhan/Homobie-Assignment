...
function SIPGraph({ data, compareData }) {
    const combinedData = data.data.map((d, i) => ({
        ...d,
        ...compareData.reduce((acc, c, idx) => ({ ...acc, [`compare${idx + 1}`]: c.data[i]?.value }), {}),
    }));
        ...
        <div className="col-12 col-md-6">
            <div className="card glassmorphic-card">
                <div className="card-body">
                    <h2 className="card-title h5">SIP Growth Timeline</h2>
                    <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={combinedData}>
                            ...
                            <Tooltip />
                            <Legend />
                            <Line type="monotone" dataKey="value" stroke="#26A69A" name="Base Value" />
